...
contract MogulOrganisation {
    ...
    uint256 constant public INITIAL_MGLTOKEN_SUPPLY = 1000000000000000000;
    
    // TODO: set this address to real one. Now it's set to 9th of testrpcs
    

    constructor(address _bondingMath, address _mogulDAI, address _movieToken, uint256 _mglOrgDaiSupply, address _mogulBank) public {
    ...
    function invest(uint256 _daiAmount) public {
        ...
        uint256 reserveDAIAmount = _daiAmount.div(5);
        ...
        mglOrgDaiSupply = mglOrgDaiSupply.add(_daiAmount);
        mglOrgDaiReserve = mglOrgDaiReserve.add(reserveDAIAmount);
